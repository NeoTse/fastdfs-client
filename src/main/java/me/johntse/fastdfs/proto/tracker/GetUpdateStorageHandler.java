...
/**
 * 更新信息Storage选择器，根据给定的文件路径获取一个Storage用于其信息更新，比如元数据.
 *
 * @author johntse
 * @since 0.1.0
 */
public class GetUpdateStorageHandler extends AbstractHandler<StorageNodeLite> {
    /**
     ...
     */
    public GetUpdateStorageHandler(FetchOneStorageParameters parameters,
     ...
     * @param response  选择器使用的Response对象
     */
    public GetUpdateStorageHandler(String groupName, String filePath,
                                   Request request, Response response) {
